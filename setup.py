...
setup(
    ...
    long_description='Ontology_sunburst allows to represent a set of element (compounds, reactions, pathways, etc..) throught a sunburst diagram showing proportion of ontology classes. Works for Metacyc, Chebi roles and EC ontologies.',
